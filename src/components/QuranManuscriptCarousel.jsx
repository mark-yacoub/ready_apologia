...
export default function QuranManuscriptCarousel({ manuscripts, surah, ayah, verseLabel }) {
    ...
    <div className="carousel-container select-none">
      ...
      >
        {manuscripts.map((ms, index) => {
          ...
          let formStr = '';
          if (ms.script_style) {
            formStr = `, in ${ms.script_style} script,`;
          }
              ...
              <div className={`slide-card ${activeSlide === index ? 'active-card' : 'inactive-card'}`}>
                ...
                <div className="ms-metadata-block">
                  ...
                  <div className="ms-specs-grid">
                    {ms.variants_and_typos && (
                      <div className="spec-cell col-span-2 variants-highlight">
                        <span className="spec-label">Variants & Typos</span>
                        <span className="spec-value">{ms.variants_and_typos}</span>
                      </div>
                    )}
                    <div className="spec-cell">
                      <span className="spec-label">Date</span>
                      <span className="spec-value">AD {ms.latest_date} ({ms.date_range_english || 'Unknown'})</span>
                    </div>
                    <div className="spec-cell">
                      <span className="spec-label">Script Style</span>
                      <span className="spec-value">{ms.script_style || 'Unknown'}</span>
                    </div>
                    <div className="spec-cell">
                    ...
                    <div className="spec-cell col-span-2">
                      <span className="spec-label">Quranic Range</span>
                      <span className="spec-value">{ms.quranic_range || 'Unknown'}</span>
                    </div>
                  </div>

                  {ms.interesting_info && (
                    <div className="ms-context-info">
                      <span className="context-label">Context & Details</span>
