...
export function getEvidenceColor(evidenceId) {
  if (!evidenceId) return appleColors[3]; // default Slate Blue
  if (explicitEvidenceIndices[evidenceId] !== undefined) {
    return appleColors[explicitEvidenceIndices[evidenceId]];
  }
